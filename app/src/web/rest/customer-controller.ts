...
import { CustomerApplicationService } from './../../education-system/application/customer/customer-application-service';
import { RegisterCustomerCommand } from './../../education-system/application/customer/commands/register-customer-command';
