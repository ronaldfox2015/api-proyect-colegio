...
var TypeORMUserRepository = /** @class */ (function () {
    ...
    TypeORMUserRepository.prototype.getByNickAndPassword = function (nick, password) {
        var _this = this;
        return this._repositoryDb.getConnection().then(function (connection) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, connection.getRepository(User_1.User).createQueryBuilder('u').where("u.nomUsuario=:nick", {
                        nick: nick
    ...
    TypeORMUserRepository = __decorate([
        ...
        __metadata("design:paramtypes", [Mysql_1.Mysql])
