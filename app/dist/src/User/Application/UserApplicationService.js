...
var UserApplicationService = /** @class */ (function () {
    function UserApplicationService(_userService) {
        this._userService = _userService;
    }
    UserApplicationService.prototype.login = function (authInput) {
        return __awaiter(this, void 0, void 0, function () {
            var rol, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._userService.role(authInput.rol())];
                    case 1:
                        rol = _a.sent();
                        if (typeof rol === 'undefined') {
                            throw new HttpException_1.HttpException(400, 'el rol no existe');
                        }
                        return [4 /*yield*/, this._userService.getByNickAndPassword(authInput.user(), authInput.password(), authInput.rol())];
                    case 2:
                        user = _a.sent();
    ...
    UserApplicationService = __decorate([
