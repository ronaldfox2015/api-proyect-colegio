...
var UserApplicationService = /** @class */ (function () {
    function UserApplicationService(_userRepo) {
     ...
     * @param pasword
     */
    UserApplicationService.prototype.login = function (name, pasword) {
        return __awaiter(this, void 0, void 0, function () {
            var login;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._userRepo.islogin(name, pasword)];
                    case 1:
                        login = _a.sent();
                        console.log(login);
