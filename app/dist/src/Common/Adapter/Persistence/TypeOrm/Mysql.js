...
var Mysql = /** @class */ (function () {
    function Mysql(connectionParameters) {
        this.connectionParameters = connectionParameters;
    }
    // tslint:disable-next-line: whitespace
    Mysql.prototype.manager = function () {
        return __awaiter(this, void 0, void 0, function () {
            var connection;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.createConnection(this.connectionParameters).then(function (con) {
                            return con.manager;
